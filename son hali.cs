...
for (int raund = 0; raund < 5; raund++)
{
    ...
    do
    {
        ...
        if (seçim == "A1" || seçim == "a1") { Console.WriteLine("CHOOSE a LETTER"); break; }
        else if (seçim == "A2" || seçim == "a2") { Console.WriteLine("CHOOSE a LETTER"); break; }
        else if (seçim == "A3" || seçim == "a3") { Console.WriteLine("CHOOSE a LETTER"); break; }
        else if (seçim == "B1" || seçim == "b1") { Console.WriteLine("CHOOSE a LETTER"); break; }
        else if (seçim == "B2" || seçim == "b2") { Console.WriteLine("CHOOSE a LETTER"); break; }
        else if (seçim == "B3" || seçim == "b3") { Console.WriteLine("CHOOSE a LETTER"); break; }
        else if (seçim == "C1" || seçim == "c1") { Console.WriteLine("CHOOSE a LETTER"); break; }
        else if (seçim == "C2" || seçim == "c2") { Console.WriteLine("CHOOSE a LETTER"); break; }
        else if (seçim == "C3" || seçim == "c3") { Console.WriteLine("CHOOSE a LETTER"); break; }
