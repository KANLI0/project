    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (a == "D" && b == "E" && c == "U" || c == "D" && b == "E" && a == "U")
            {
                ...
                { human_point = human_point + 120; computer_current = computer_current + 120; }
                else if (colorA != colorB && colorB != colorC && colorA != colorC)
                { human_point = human_point + 110; computer_current = computer_current + 110; }
                else
                { human_point = human_point + 100; computer_current = computer_current + 100; }
            ...
            {
                if (colorA == colorB && colorB == colorC)
                { human_point = human_point + 90; computer_current = computer_current + 90; }
                else if (colorA != colorB && colorB != colorC && colorA != colorC)
                { human_point = human_point + 80; computer_current = computer_current + 80; }
                else
                { human_point = human_point + 70; computer_current = computer_current + 70; }
            }
            ...
            {
                if (colorA == colorB && colorB == colorC)
                { human_point = human_point + 30; computer_current = computer_current + 30; }
                else if (colorA != colorB && colorB != colorC && colorA != colorC)
                { human_point = human_point + 20; computer_current = computer_current + 20; }
                else
                { human_point = human_point + 0; computer_current = computer_current + 0; }
            ...
            {
                if (colorA == colorB && colorB == colorC)
                { human_point = human_point + 60; computer_current = computer_current + 60; }
                else if (colorA != colorB && colorB != colorC && colorA != colorC)
                { human_point = human_point + 50; computer_current = computer_current + 50; }
                else
                { human_point = human_point + 40; computer_current = computer_current + 40; }
            }
            if (d == e && e == f)
            {
